...
export default function NewCareerSection() {
  return (
    <section className="relative w-full bg-gradient-to-r from-[#004D73] to-[#0076A3] text-white overflow-hidden">
      {/* Main Content */}
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-20 lg:py-28 gap-14">
        {/* Left side - Heading */}
        <div className="flex-1 text-center lg:text-left">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-3 drop-shadow-md">
            Are you ready to start a
          </h2>

          <div className="flex flex-col sm:flex-row sm:items-end justify-center lg:justify-start flex-wrap leading-none">
            <h1 className="text-[6rem] sm:text-[8rem] md:text-[10rem] lg:text-[11rem] font-extrabold tracking-tight drop-shadow-[0_3px_6px_rgba(0,0,0,0.4)] sm:mr-2 md:mr-3">
              new
            </h1>
            <h1 className="text-[5rem] sm:text-[6rem] md:text-[8rem] lg:text-[9rem] font-extrabold tracking-tight drop-shadow-[0_3px_6px_rgba(0,0,0,0.4)] flex items-end">
              career
              <span className="text-[5rem] sm:text-[6rem] md:text-[8rem] lg:text-[9rem] font-extrabold text-white drop-shadow-[0_3px_6px_rgba(0,0,0,0.4)] ml-1 sm:ml-2">
                ?
              </span>
            </h1>
          </div>
        ...
        <div className="flex-1 max-w-lg text-center lg:text-left relative z-20">
          <p className="text-base sm:text-lg md:text-xl leading-relaxed text-gray-50 drop-shadow-sm mb-10">
